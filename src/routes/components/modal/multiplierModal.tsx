...
const MoreFire = () => {
    ...
    return (<>
        <div className="flex flex-col gap-4">
            ...
            <NButton as={Link} to={routesConfig.socialTask} className="rounded-full text-base !bg-[#19FFE0] !text-[#000] !rounded-lg flex items-center justify-center !py-6 !min-h-fit" >
                <>
            ...
            <NButton as={Link} to={routesConfig.invite} className="rounded-full text-base !bg-white !text-[#000] flex items-center justify-center !py-6 !rounded-lg !min-h-fit" >
                <>
                ...
                <GradientBorderCard className="py-4 px-6 flex flex-col gap-4">
                    <>
                        ...
                        <span className="text-sub text-sm ml-auto teacher">
                            Earn 30 more <span className="text-[#22D3EE] font-bold">🔥FIRE</span> to become Ultra
                        </span>
                    </>
                </GradientBorderCard>
