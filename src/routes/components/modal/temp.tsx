...
const HistoryTable = ({ type, columns, rows, classNames }: any) => {
    ...
    const tabs = [
        {
            id: "deposit",
            label: "Deposit",
            content: <HistoryTable type="deposit" columns={depositColumns} rows={dataList?.data?.list} />
        },
        {
            id: "withdraw",
            label: "Withdraw",
            content: <HistoryTable type="withdraw" columns={withdrawColumns} rows={dataList?.data?.list} />
        },
    ];
