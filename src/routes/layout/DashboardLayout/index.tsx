...
const Accordion_ = ({ origin, navs, children }: any) => {
  ...
  return navs?.children?.length ? (
    <Accordion
      defaultSelectedKeys="all"
      fullWidth
      className="accordion !px-0 [&_button]:!py-0 [&_data-[open=true]_.nav-item]:!pb-0"
    >
      <AccordionItem
        key={navs?.text}
        aria-label={navs?.text}
        title={children}
        className=""
      >
...
const Projector = (props?: any) => (
  ...
  >
    ...
    <path
      d="M1 17C1 15.3431 2.34315 14 4 14H5C5.55228 14 6 14.4477 6 15V23C6 23.5523 5.55228 24 5 24H2C1.44772 24 1 23.5523 1 23V17Z"
      stroke="white"
      strokeOpacity="1"
      strokeWidth="3"
      mask="url(#path-4-inside-1_861_2525)"
    />
    ...
    <path
      d="M7 14C7 12.3431 8.34315 11 10 11H14C15.6569 11 17 12.3431 17 14V23C17 23.5523 16.5523 24 16 24H8C7.44772 24 7 23.5523 7 23V14Z"
      stroke="white"
      strokeOpacity="1"
      strokeWidth="3"
      mask="url(#path-5-inside-2_861_2525)"
    />
    ...
    <path
      d="M23 17C23 15.3431 21.6569 14 20 14H19C18.4477 14 18 14.4477 18 15V23C18 23.5523 18.4477 24 19 24H22C22.5523 24 23 23.5523 23 23V17Z"
      stroke="white"
      strokeOpacity="1"
      strokeWidth="3"
      mask="url(#path-6-inside-3_861_2525)"
    />
  </svg>
);
...
const Provider = (props?: any) => (
  ...
  >
    ...
    <rect
      ...
      strokeOpacity="1"
      strokeWidth="3"
      mask="url(#path-18-inside-1_439_12346)"
    />
  </svg>
);
  ...
  return (
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M8.75 4.75H17.25C18.6307 4.75 19.75 5.86929 19.75 7.25V12C19.75 12.4142 20.0858 12.75 20.5 12.75C20.9142 12.75 21.25 12.4142 21.25 12V7.25C21.25 5.04086 19.4591 3.25 17.25 3.25H8.75C6.54086 3.25 4.75 5.04086 4.75 7.25V18.75C4.75 20.9591 6.54086 22.75 8.75 22.75H11.25C11.6642 22.75 12 22.4142 12 22C12 21.5858 11.6642 21.25 11.25 21.25H8.75C7.36929 21.25 6.25 20.1307 6.25 18.75V7.25C6.25 5.86929 7.36929 4.75 8.75 4.75Z"
        fill="currentColor"
      />
      <circle
        cx="17.5"
      ...
      />
      <path
        d="M15.4412 18.4983L16.6522 19.9031L19.3862 17.6697"
        stroke="currentColor"
        strokeWidth="1.2"
        strokeLinecap="round"
        strokeLinejoin="round"
    ...
    >
      <g clipPath="url(#clip0_1608_4762)">
        <path
          fillRule="evenodd"
          clipRule="evenodd"
          d="M12.3086 6.53856C12.3086 8.45032 10.7588 10.0001 8.84706 10.0001C6.9353 10.0001 5.38552 8.45032 5.38552 6.53856C5.38552 4.62681 6.9353 3.07703 8.84706 3.07703C10.7588 3.07703 12.3086 4.62681 12.3086 6.53856ZM11.0009 6.53856C11.0009 7.7281 10.0366 8.69241 8.84706 8.69241C7.65752 8.69241 6.69321 7.7281 6.69321 6.53856C6.69321 5.34903 7.65752 4.38472 8.84706 4.38472C10.0366 4.38472 11.0009 5.34903 11.0009 6.53856Z"
          fill="currentColor"
        />
        <path
          fillRule="evenodd"
          clipRule="evenodd"
          d="M2.30859 14.5295V16.1538C2.30859 16.5786 2.65299 16.923 3.07782 16.923H15.3855C15.8104 16.923 16.1547 16.5786 16.1547 16.1538V14.5295C16.1547 13.0254 15.0673 11.7418 13.5837 11.4945L10.4963 10.9799C9.65898 10.8404 8.80436 10.8404 7.96706 10.9799L4.87967 11.4945C3.39602 11.7418 2.30859 13.0254 2.30859 14.5295ZM15.0009 15.7691H3.46244V14.5295C3.46244 13.5895 4.14208 12.7872 5.06936 12.6326L8.15675 12.1181C8.86846 11.9994 9.59488 11.9994 10.3066 12.1181L13.394 12.6326C14.3213 12.7872 15.0009 13.5895 15.0009 14.5295V15.7691Z"
          fill="currentColor"
        />
        <path
          d="M14.8086 9.03856H13.0778V7.88472H14.8086V6.15395H15.9624V7.88472H17.6932V9.03856H15.9624V10.7693H14.8086V9.03856Z"
          fill="currentColor"
        />
      </g>
      <defs>
  ...
  return (
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M5 4.00012C5.55228 4.00012 6 4.44784 6 5.00012V5.25012H13C14.2588 5.25012 15.32 6.09587 15.6465 7.25012H19.25C20.7688 7.25012 22 8.48134 22 10.0001V16.0001C22 17.5189 20.7688 18.7501 19.25 18.7501H12.5C11.2574 18.7501 10.25 17.7428 10.25 16.5001V15.7501H6V21.0001C6 21.5524 5.55228 22.0001 5 22.0001C4.44772 22.0001 4 21.5524 4 21.0001V5.00012C4 4.44784 4.44772 4.00012 5 4.00012ZM11.75 15.7501V16.5001C11.75 16.9143 12.0858 17.2501 12.5 17.2501H19.25C19.9404 17.2501 20.5 16.6905 20.5 16.0001V10.0001C20.5 9.30977 19.9404 8.75012 19.25 8.75012H15.75V13.5001C15.75 14.7428 14.7426 15.7501 13.5 15.7501H11.75ZM6 14.2501V6.75012H13C13.6904 6.75012 14.25 7.30977 14.25 8.00012V13.5001C14.25 13.9143 13.9142 14.2501 13.5 14.2501H6Z"
        fill="currentColor"
      />
    </svg>
  );
            ...
            <div className="relative">
              ...
              >
                <rect
                  ...
                  height="17"
                  rx="3.5"
                  fill="url(#paint0_linear_1053_13338)"
                  fillOpacity="0.2"
                />
                <rect
                  x="0.5"
                  ...
                  height="17"
                  rx="3.5"
                  stroke="url(#paint1_linear_1053_13338)"
                />
                <path
