...
export const AcademyCard = ({item}:{item:any})=>{
    ...
    <GradientBorderCard className="!rounded-lg px-4 lg:px-6 py-4 flex justify-between cursor-pointer" >
        <div className="flex flex-col gap-2 flex-1">
            <span className="unbounded-16-24-400">{item.title}</span>
            <span className="unbounded-14-16-400 tracking-wider min-h-6">{item.subTitle}</span>
        </div>
...
const AcademyPage = () => {
    return (
        <>
            ...
            {/* 主要内容部分 */}
            <div className="w-full main-container mx-auto mt-8 relative z-[2] flex flex-col gap-4">
                {
