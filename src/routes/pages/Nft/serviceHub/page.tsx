            ...
            <div className="container mx-auto relative z-10 py-12">
                ...
                <div className={cn("flex gap-4 ", isMobile ? "flex-col" : "")}>
                    ...
                    <div className="flex-[2] flex flex-col gap-4">
                        ...
                        >
                            <div className={cn("!text-3xl !font-[300] title", isMobile ? "text-left" : "text-right")}>{balance ? `${balance.amount} ${balance.symbol}` : "0 USDC"}</div>
                        </StatCard>
                        ...
                        >
                            <div className={cn("!text-3xl !font-[300] title", isMobile ? "text-left" : "text-right")}>{voucherCnt}</div>
                        </StatCard>
                    </div>
                </div>
                ...
                <div className="mb-12">
                    <div className="flex flex-col items-center my-12 gap-4">
                        <h2 className="title !text-3xl !font-[300] uppercase">MY ZK HARVESTER</h2>
