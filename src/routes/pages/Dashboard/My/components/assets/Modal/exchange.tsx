                    ...
                    <ModalBody>
                        <div className="flex flex-col gap-4">
                            <div className="flex flex-col gap-1 relative">
                                ...
                                <div className="border border-[#FFFFFF52] rounded-[16px] p-4 flex flex-col gap-3 bg-[#000000]">
                                    ...
                                    <Input
                                        ...
                                        suffix={<div className="text-base font-[500] flex items-center gap-2 p-2 bg-[#FFFFFF1F] rounded-full">
                                            <img className="size-6" src={getImageUrl('@/assets/images/tokens/cysic.svg')} />
                                            <div>CYSIC</div>
                                        </div>} />
                                    <div className="flex items-center gap-1 text-[#00F0FF] self-end">
                                ...
                                {/* exchange */}
                                <div className="cursor-pointer absolute left-1/2 top-1/2 -translate-y-1/2 -translate-x-1/2">
                            ...
                            <div className="text-[#A3A3A3]">1 Cysic = 1.2345 GCYS</div>
