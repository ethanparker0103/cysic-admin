...
const VerifierStatus = ()=>{
    ...
    const scrollProverStatus = profile?.[address as string] ? !!profile?.[address as string]?.verifier?.find((i: any) => i?.ID) : undefined

    return <div className="flex flex-col gap-4 p-8 rounded-[16px] border border-[rgba(255,255,255,0.2)]">
