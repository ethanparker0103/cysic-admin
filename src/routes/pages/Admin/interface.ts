...
// 徽章状态常量
// export const EStampStatus = {
//     StampStatusEnabled: true, // 启用
//     StampStatusDisabled: false, // 禁用
// }
...
// 管理员用户状态常量
// export const EAdminUserStatus = {
//     AdminUserStatusDisabled: false, // 禁用
//     AdminUserStatusEnabled: true, // 启用
// }
...
// 邀请码状态常量
// export const EInviteCodeStatus = {
//     InviteCodeStatusUnavailable: false, // 不可用
//     InviteCodeStatusAvailable: true, // 可用
// }
...
// 任务强制锁定状态常量
// export const ETaskForceLocked = {
//     TaskForceLockedNo: false, // 不强制锁定
//     TaskForceLockedYes: true, // 强制锁定
// }
...
// 用户签到状态常量
// export const EUserSignInStatus = {
//     UserSignInStatusNotSigned: false, // 未签到
//     UserSignInStatusSigned: true, // 已签到
// }
